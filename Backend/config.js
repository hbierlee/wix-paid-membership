...
// page URLs
export const PREMIUM_PAGE_URL = `${SITE_URL}/subscribers`;  // if you change 'subscribers' to something else, change the function `subscribers_Router` and `subscribers_SiteMap` to that value too!
